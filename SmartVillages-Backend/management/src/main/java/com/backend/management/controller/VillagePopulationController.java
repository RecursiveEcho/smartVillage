...
public class VillagePopulationController {
  ...
  public Result<String> createVillagePopulation(
      @RequestBody @Valid VillagePopulationCreateDTO villagePopulationCreateDTO) {
  ...
  public Result<IPage<VillagePopulationSimpleVO>> getVillagePopulationList(
    ...
    return Result.success(
        villagePopulationService.getVillagePopulationList(
            current, size, householdNo, fullName, gender, relationToHead));
  }
  ...
  public Result<String> updateVillagePopulation(
      @PathVariable Long id,
      @RequestBody @Valid VillagePopulationUpdateDTO villagePopulationUpdateDTO) {
