...
public class VillageHouseLandController {
  ...
  public Result<Integer> createVillageHouseLand(
      @RequestBody VillageHouseLandCreateDTO villageHouseLandCreateDTO) {
  ...
  public Result<IPage<VillageHouseLandSimpleVO>> getVillageHouseLandList(
    ...
    return Result.success(
        villageHouseLandService.getVillageHouseLandList(
            current, size, bizType, ownerName, location));
  }
  ...
  public Result<String> updateVillageHouseLand(
      @PathVariable Integer id, @RequestBody VillageHouseLandUpdateDTO villageHouseLandUpdateDTO) {
