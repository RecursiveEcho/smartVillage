...
/**
 * @author chenyang &#064;date 2026/4/24 &#064;description 民生服务工单控制器
 */
@RestController
...
public class VillageServiceTicketController {
  ...
  public Result<Integer> create(
      @Valid @RequestBody ServiceTicketCreateDTO dto, HttpServletRequest request) {
  ...
  public Result<IPage<ServiceTicketSimpleVO>> getMyServiceTicketList(
    ...
    return Result.success(
        villageServiceTicketService.getServiceTicketList(
            current, size, serviceType, status, request));
  }
  ...
  public Result<ServiceTicketDetailVO> getMyDetail(
  ...
  public Result<IPage<ServiceTicketSimpleVO>> pageCadre(
    ...
    return Result.success(
        villageServiceTicketService.pageCadre(
            current, size, serviceType, status, starTime, endTime));
  }
  ...
  public Result<String> processingServiceTicket(
      @PathVariable Long id, @RequestBody ServiceTicketDoneDTO dto, HttpServletRequest request) {
