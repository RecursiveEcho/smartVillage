...
/**
 * @author chenyang &#064;date 2026/4/15 &#064;description 村民留言控制器
 */
@Validated
@RestController
...
public class InteractionController {
  ...
  /**
   * @author chenyang &#064;date 2026/4/15 &#064;description 新增村民留言
   * @param dto 村民留言创建DTO
   * @return 操作结果文案
   */
  @Operation(summary = "新增村民留言")
  @PostMapping("/interactions/messages")
  public Result<InteractionCreateVO> createMessage(
      @RequestBody @Valid InteractionCreateDTO dto, HttpServletRequest request) {
    return Result.success(interactionService.createMessage(dto, request));
  }

  /**
   * @author chenyang &#064;date 2026/4/15 &#064;description 获取村民留言列表
   * @param current 当前页
   * @param size 每页数量
   * @return 村民留言列表
   */
  ...
  /**
   * @author chenyang &#064;date 2026/4/22 &#064;description 回复村民留言
   * @param id 留言id
   * @param dto 回复村民留言DTO
  ...
  public Result<String> replyMessage(
      ...
      @RequestBody @Valid ReplyInteractionDTO dto,
      HttpServletRequest request) {
    return Result.success(interactionService.replyMessage(id, dto, request));
  }

  /**
   * @author chenyang &#064;date 2026/4/22 &#064;description 获取村民留言详情
   * @param id 留言id
   * @return 村民留言详情
   */
  ...
  /**
   * @author chenyang &#064;date 2026/4/22 &#064;description 管理端获取村民留言列表
   * @param current 当前页
   * @param size 每页数量
   * @param status 状态
   * @param type 类型
  ...
  public Result<IPage<InteractionDetailVO>> getMessageListByCadre(
    ...
    return Result.success(
        interactionService.getMessageListByCadre(current, size, status, type, startTime, endTime));
  }

  /**
   * @author chenyang &#064;date 2026/4/22 &#064;description 我的留言
   * @param current 当前页
   * @param size 每页数量
   * @return 我的留言
   */
  ...
  /**
   * @author chenyang &#064;date 2026/4/22 &#064;description 我的留言详细
   * @param request HTTP请求
   * @param id 留言id
   * @return 我的留言详细
   */
  ...
  public Result<InteractionDetailVO> getMyMessageDetail(
      HttpServletRequest request, @PathVariable Long id) {
    return Result.success(interactionService.getMyMessageDetail(request, id));
  }

  /**
   * @author chenyang &#064;date 2026/4/22 &#064;description 村民撤回留言
   * @param request HTTP请求
   * @param id 留言id
   * @return 操作结果文案
   */
  ...
  /**
   * @author chenyang &#064;date 2026/4/22 &#064;description 管理端处理村民留言
   * @param id 留言id
   * @param request HTTP请求
   * @return 操作结果文案
   */
  ...
  public Result<String> processingMessage(
      @PathVariable Long id, Integer status, HttpServletRequest request) {
