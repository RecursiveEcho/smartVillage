 ...
 *
 * <p>路径统一前缀 {@code /admin}；用户列表与状态实际作用于认证表数据，经 {@link AdminService} 编排。
 *
 * @author chenyang &#064;date 2026/4/2
 */
@Slf4j
@RestController
...
public class AdminController {
  ...
  /**
   * @author chenyang &#064;date 2026/4/2 &#064;description 获取当前用户信息
  ...
  /**
   * @author chenyang &#064;date 2026/4/7 &#064;description 分页查询用户
  ...
  /**
   * @author chenyang &#064;date 2026/4/8 &#064;description 启用/禁用用户
   * @param id 用户 ID
   * @param status 状态
   * @return 操作结果文案
   */
  ...
  /**
   * @author chenyang &#064;date 2026/4/18 &#064;description 创建村干部账号
   * @param authDTO 账号信息
   * @return 操作结果文案
   */
  ...
  /**
   * @author chenyang &#064;date 2026/5/7 &#064;description 查看用户详细信息
   * @param id 用户 ID
   * @return 用户详细信息
   */
  ...
  /**
   * @author chenyang &#064;date 2026/5/7 &#064;description 删除用户
   * @param id 用户 ID
   * @return 删除结果
   */
